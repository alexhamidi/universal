...
export default function HeroSection({ isLoaded }: HeroSectionProps) {
  return (
    <div className="container relative px-4 text-center max-w-7xl mx-auto mt-[12vh] min-h-[58vh] flex flex-col justify-center -mt-10">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="flex relative flex-col sm:flex-row gap-6 justify-center items-center"
        >
           <a
      href= { COMING_SOON ? undefined : 'https://github.com/fakelink.exe'}
      className={`
        ...
        ${COMING_SOON ? 'opacity-40 cursor-not-allowed' : 'shadow-[0_0_50px_-5px_rgba(228,228,231,0.5)]'}
      `}
    >
    ...
    {COMING_SOON && (
        <div className="absolute  -top-2 rotate-8 bg-yellow-300 text-black text-xs px-4 rounded-sm py-2  border-black">
